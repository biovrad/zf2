 ...
 * User
 *
 * @ORM\Table(name="user", uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_1483A5E9DFCDFE1", columns={"usr_name"})})
...
class User
{
     ...
     * @Annotation\Attributes({"tape":"text", "class":"form-control", "required":"required"})
     * @Annotation\Required({"required":"true"})
     * @Annotation\Options({"label":"Логин"})
     * @Annotation\Validator({"name":"StringLength", "option":{"min":1, "max":30}})
     */
    private $usrName;
     ...
     * @Annotation\Attributes({"tape":"password", "class":"form-control", "required":"required"})
     ...
     * @Annotation\Attributes({"tape":"password", "class":"form-control"})
     * @Annotation\Options({"label":"Повтор пароля"})
     * @Annotation\Validator({"name":"identical", "option":{"token":"usrPassword"}})
     ...
     * @Annotation\Filter({"name":"StringTrim"})
     * @Annotation\Required({"required":"true"})
     * @Annotation\Options({"name":"EmailAddress"})
     */
    private $usrEmail;
